...
//        autoCompleteTableHeight = (autoCompleteCellHeight) * (tableView.rowHeight.)
...
//    ORiginal COde Without 3 char iput limit and doenst disaapper on 0 chars
...
//    }
    ...
    func textFieldDidChange(){
        ...
        if text?.characters.count >= 3 {
            ...
            dispatch_async(dispatch_get_main_queue(), { () -> Void in
                self.autoCompleteTableView?.hidden =   self.text!.isEmpty
            })
        }
    }
